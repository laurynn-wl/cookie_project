export const category_explanation = {
    "Essential": {
        simple: "Essential cookies are needed for the website to work properly. They help with things like keeping you logged in and remebering items in your shopping basket as you move between pages.",
        technical: "Essential cookies are required for core website operations, including session management, login persitence and shopping basket functionality.", 
    }, 
    "Preference": {
        simple: "Preference cookies allow the browser to remember how you like things. For example when you set a preferred, this choice is saved so you don't need to set it again the next time you visit the website.",
    ...
    "Analytics": {
        ...
        technical: "Analytical cookies collect anonymised data on user interactions, such as page views and session durtion to enhance website performance.",
    }, 
    "Tracking": {
        simple: "Tracking cookies are used to follow what you do across different websites, they are often used to build a profile of your interests and show you adverts related to thiings you have recently viewed.", 
...
export const security_explanation = {
    httpOnly: {
        ...
        description: {
            simple: "This cookie can be seen by scripts running on the website, which could allow attackers to steal if it the website is not secure.",
    ...
    hostOnly: {
        ...
        description: {
            simple: "This cookie can be used across many parts of the website, which makes it easier for attackers to access it if one part of the website is compromised.",
    ...
    sameSite: {
        ...
        description: {
            simple: "This cookie can be sent whne you visit other websites, which could allow attackers to trrick the website into doing something on your behalf or track your activity across sites.",
